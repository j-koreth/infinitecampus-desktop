...
public class Scraper {
    public static ObservableList<GradeTable> getRecentGrades() throws FailingHttpStatusCodeException, IOException, InterruptedException {
        // Creating Browser
    ...
    public static ObservableList<GradeTable> getRecentGrades(String url, String usernameuserinput, String passworduserinput) throws FailingHttpStatusCodeException, IOException, InterruptedException {
        // Creating Browser
        java.util.logging.Logger.getLogger("com.gargoylesoftware").setLevel(Level.OFF);
        WebClient webClient = new WebClient(BrowserVersion.FIREFOX_38);
        webClient.getOptions().setCssEnabled(false);
    ...
    public static String[] getSubject() throws IOException {
        ...
        // Grades Page
        HtmlPage gradespage = gradeslink.click();
        List<HtmlBold> subjecttitlelist = (List<HtmlBold>) gradespage.getByXPath(".//*[@style='padding-top:2px;']/table/tbody/tr[1]/td/table/tbody/tr/td[1]/a/b");

        String data[] = new String[subjecttitlelist.size()];
        for(int y = 0; y < subjecttitlelist.size(); y++){
            data[y] = subjecttitlelist.get(y).asText();
        }
        webClient.close();
        return data;
    }
    public static String[] getSubject(String url, String usernameuserinput, String passworduserinput) throws IOException {
        // Creating Browser
        java.util.logging.Logger.getLogger("com.gargoylesoftware").setLevel(Level.OFF);
        WebClient webClient = new WebClient(BrowserVersion.FIREFOX_38);
        webClient.getOptions().setCssEnabled(false);
